...
import POM.Base_Class;
import POM.Review_Room_POM;

public class TC6_ReviewRoom_SignOff_page extends TC1_Login_Page{

	@Test(priority = 1)
	public void ReviewRoom_Main1() throws InterruptedException {
		...
		try {
			...
			Type_RR.selectByIndex(2);

			
			Thread.sleep(3000);
			
			RR_object.RR_Title.sendKeys(RB.getString("RS"));
			...
			Select Select_Sign_off = new Select(RR_object.Sign_OffRR);
			Select_Sign_off.selectByValue("P");

...
public class TC4_ReviewRoom_Page extends TC1_Login_Page {
	@Test(priority = 1)
	public void ReviewRoom_Main() throws InterruptedException {
		...
		try {
			...
			Type_RR.selectByIndex(0);

			Thread.sleep(3000);

			RR_object.RR_Title.sendKeys(RB.getString("RR"));
